  ...
  return (
    <div className="flex justify-center items-center ">
      <form className='flex flex-col bg-white text-gray-700 text-base rounded overflow-hidden shadow-lg m-10 py-8 px-10 md:w-[23%]' onSubmit={handleSubmit}>
        <h1 className="text-center text-2xl mb-3 text-gray-900">Login</h1>
        ...
        <input
          ...
          id='password'
        />
        <button className="px-2 py-3 rounded-xl text-xl text-white bg-blue-600"  disabled={loading}>Login</button>
      </form>
    </div> 
  )
}
